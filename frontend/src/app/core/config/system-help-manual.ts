...
export const ADMIN_HELP_TOPICS: HelpTopic[] = [
  {
    ...
    path: '/admin',
    summary: 'View school KPIs and quick links to every module.',
    steps: [
      'Open Dashboard from the sidebar or click Home in the top bar.',
      'Review student, staff, finance, and attendance summary cards.',
      'Use the module tiles to jump to Students, Finance, Examinations, and more.',
    ],

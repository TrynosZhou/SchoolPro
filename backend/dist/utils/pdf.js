...
async function generateReportCardPdf(data) {
    return new Promise((resolve, reject) => {
        ...
        const baseRowH = 24;
        const drawTableHeader = (headerY, headerRowH) => {
        ...
        doc.text(`Generated by School Pro · ${generated.toLocaleDateString()} ${generated.toLocaleTimeString()}`, margin, footerY, { width: contentW, align: 'center' });
        doc.end();
    });
}

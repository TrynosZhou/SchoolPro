...
export async function seedDatabase() {
  ...
  await userRepo.save([
    userRepo.create({ email: 'principal@schoolpro.ac.zw', passwordHash: hash, firstName: 'Mary', lastName: 'Principal', role: UserRole.PRINCIPAL, phone: '+263771000002' }),
    userRepo.create({ email: 'admin@schoolpro.ac.zw', passwordHash: hash, firstName: 'Peter', lastName: 'Admin', role: UserRole.ADMIN, phone: '+263771000003' }),
  ]);
